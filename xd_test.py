...
from dataset import XDDataset_Whole_test_train
from utils.tools import fixed_smooth
...
if __name__ == '__main__':
    ...
    test_dataset = XDDataset_Whole_test_train( args.test_list, True,args.attn_window)
    ...
    model_path = '/root/StreamVAD/model/8208_xd.pth'
